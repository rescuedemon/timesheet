// Weekly summary card component for timesheet view
// Displays week navigation and daily time summaries
      ...
      <CardContent className="p-2">
                      ...
                      <div 
                        ...
                        style={{
                          background: `linear-gradient(45deg, 
                            ...
                            ${hexToRgba(progressBarColor, 0.3)} 25%, 
        ...
        <style>{`
          @keyframes windFlow1 {
            ...
            25% { background-position: 50% 50%; opacity: 0.9; }
            50% { background-position: 100% 100%; opacity: 0.7; }
            75% { background-position: 150% 150%; opacity: 0.9; }
            100% { background-position: 200% 200%; opacity: 0.7; }
          }
          
          @keyframes windFlow2 {
            0% { background-position: 100% 0%; }
            25% { background-position: 150% 50%; opacity: 0.7; }
            50% { background-position: 200% 100%; opacity: 0.5; }
            75% { background-position: 250% 150%; opacity: 0.7; }
            100% { background-position: 300% 200%; opacity: 0.5; }
          }
          
          @keyframes windFlow3 {
            0% { background-position: 0% 100%; }
            25% { background-position: 50% 150%; opacity: 0.5; }
            50% { background-position: 100% 200%; opacity: 0.3; }
            75% { background-position: 150% 250%; opacity: 0.5; }
            100% { background-position: 200% 300%; opacity: 0.3; }
          }
        `}</style>
      </CardContent>
    </Card>
